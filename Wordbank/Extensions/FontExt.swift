...
extension Font {
    ...
    static func newsreader(_ weight: Newsreader = .regular, size: CGFloat, relativeTo textStyle: TextStyle = .body) -> Font {
        .custom(weight.rawValue, size: size, relativeTo: textStyle)
    }
    
    static func instrumentSans( _ weight: InstrumentSans = .regular, size: CGFloat, relativeTo textStyle: TextStyle = .body) -> Font {
        .custom(weight.rawValue, size: size, relativeTo: textStyle)
    }
